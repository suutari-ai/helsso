# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-02-01 14:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_scopes', multiselectfield.db.fields.MultiSelectField(choices=[('email', 'E-mail'), ('profile', 'Profile'), ('address', 'Address'), ('github_username', 'GitHub username')], default=['email', 'profile'], help_text='Select scopes to include to the API tokens.', max_length=1000, verbose_name='required scopes')),
            ],
            options={
                'verbose_name': 'API',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identifier', models.CharField(editable=False, help_text='The scope identifier as known by the API provider application.  Filled automatically from API identifier and scope specifier.', max_length=150, unique=True, verbose_name='identifier')),
